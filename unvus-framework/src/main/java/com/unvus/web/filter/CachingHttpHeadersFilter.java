...
public class CachingHttpHeadersFilter implements Filter {
    ...
    private UnvusProperties unvusProperties;

    /**
     * <p>Constructor for CachingHttpHeadersFilter.</p>
     *
     * @param unvusProperties a {@link UnvusProperties} object.
     */
    public CachingHttpHeadersFilter(UnvusProperties unvusProperties) {
        this.unvusProperties = unvusProperties;
    }

    /** {@inheritDoc} */
    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(unvusProperties.getHttp().getCache().getTimeToLiveInDays());
    }
