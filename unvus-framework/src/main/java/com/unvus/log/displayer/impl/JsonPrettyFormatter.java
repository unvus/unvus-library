...
public class JsonPrettyFormatter implements LogFormatter {
    ...
    public String entry(String methodName, boolean showArgs, String[] params, Object[] args) throws Exception {
        ...
        return message.add(":").add(JsonUtil.getMapper().writerWithDefaultPrettyPrinter().writeValueAsString(map)).toString();
    }
