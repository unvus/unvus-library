...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static <T> T now(ConvertTo convertTo) {
        Class<T> type = convertTo.getType();
    ...
    public static void main(String[] args) {
        ...
        ZonedDateTime zonedDateTime = DateUtils.convertLongToZonedDateTime(System.currentTimeMillis());

        System.out.println(zonedDateTime.format(format));

        LocalDate localDate = DateUtils.convertFromFormattedStr("1976-09-11", "yyyy-MM-dd", DateUtils.ConvertTo.LocalDate);

        System.out.println(localDate);

        LocalDateTime localDateTime = DateUtils.convertFromFormattedStr("1976-09-11 17:23:32", "yyyy-MM-dd HH:mm:ss", DateUtils.ConvertTo.LocalDateTime);
